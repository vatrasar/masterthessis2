...
from Events.Game.move.algos.GameObjects.data_lists.tools.map_ranges_tools import put_point_in_range_of_map, get_max_hand_range_in_x
...
def init_jump(path:typing.List[FluidCell], uav_position, uav_velocity, hand, hand_jump_velocity, settings, current_time, tk_master, game_state:GameState, event_list,rand:Random,future_target=None):
    ...
    if target_point==None:
        ...
        if settings.is_hand_deviation:
            ...
            put_point_in_range_of_map(target_point,settings.map_size_x,settings.tier1_distance_from_intruder-10,settings.intuder_size)
