...
def check_is_horizontal_distance_form_hands_safe(hands_list:typing.List[Hand], uav, safe_margin,jump_velocity,settings:Settings):
    ...
    save_distance=max(jump_velocity*time_of_uav_to_take_distance,safe_distance_to_take)
...
def check_if_point_safe_static(position, settings:Settings,hands_list:typing.List[Hand],jump_velocity):
    ...
    time_of_uav_to_take_distance=safe_distance_to_take/settings.v_of_uav
    my_save_distance=max(jump_velocity*time_of_uav_to_take_distance,safe_distance_to_take)
