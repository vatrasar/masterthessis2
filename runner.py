...
from Events.change_tier_event import plan_enter_from_tier2
...
class Runner():
    ...
    def run(self):
            ...
            for uav in self.game_state.uav_list:
                plan_enter_from_tier2(self.events_list,self.settings,self.current_time,uav,self.rand,self.master)
