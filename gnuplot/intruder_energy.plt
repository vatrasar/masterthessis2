...
'intruder_energy_data.txt' using 1:2 with lines lc 4 lw 3 title "zuzyta energia",\
 'intruder_energy_data.txt' using 1:4 with lines lc 7 lw 3 title "energia maksymalna"
